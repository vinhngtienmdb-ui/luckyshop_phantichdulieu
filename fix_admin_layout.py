...
pattern = r'<main id="admin_dashboard".*?<!-- Content Area -->\s*<div style="flex: 1; overflow-y: auto; padding: 20px; background: #fff;">'

replacement = """<main id="admin_dashboard" style="display:none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: #f8fafc; z-index: 9999; flex-direction: column; margin: 0; border-radius: 0; border: none; overflow: hidden; box-sizing: border-box; font-family: 'Inter', sans-serif;">
       <!-- Premium Header -->
...
print(f"Replaced {n} occurrences of layout structure")
